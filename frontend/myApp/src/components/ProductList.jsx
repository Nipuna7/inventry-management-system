...
import { Package, Search, Eye, Edit, Trash2, Plus, Calendar, DollarSign, Hash, Tag } from 'lucide-react';
          ...
          {filteredProducts.length === 0 ? (
            ...
            filteredProducts.map((product) => (
              ...
              >
                ...
                <div style={productInfoStyle}>
                  <Calendar size={16} />
                  Mfg: {formatDate(product.man_date)}
                </div>
                
                <div style={productInfoStyle}>
                  <Calendar size={16} />
                  Exp: {formatDate(product.exp_date)}
                </div>
        ...
        <div style={modalStyle} onClick={() => setSelectedProduct(null)}>
          <div style={modalContentStyle} onClick={(e) => e.stopPropagation()}>
            ...
            <div style={{display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px', marginBottom: '16px'}}>
              ...
              <div>
                <strong>Manufacturing Date:</strong> {formatDate(selectedProduct.man_date)}
              </div>
              <div>
                <strong>Expiry Date:</strong> {formatDate(selectedProduct.exp_date)}
              </div>
            </div>
